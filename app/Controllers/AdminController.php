...
class AdminController extends BaseController
{
    ...
    public function user()
    {
        ...
        if ($this->request->getVar('keyword')) {
            ...
            $data['all_siswa'] = $this->UserModel->select('nis, nama_user, foto_profil, jabatan')->where('jabatan', 2)->groupStart()->like(['nis' => $keyword,])->orLike('nama_user', $keyword)->groupEnd()->paginate(10, 'user');
            ...
            $data['all_siswa'] = $this->UserModel->select('nis, nama_user, foto_profil, jabatan')->where('jabatan', 2)->paginate(10, 'user');
            // Menghitung jumlah data yang ditemukan
    ...
    public function book()
    {
        ...
        if ($this->request->getVar('keyword')) {
            ...
            if (session()->get('kategori_book')) {
                ...
                $data['all_buku'] = $this->BukuModel->select('no_buku, nama_buku, sampul_buku, nama_kategori, status_buku')->join('kategori', 'kategori.id_kategori = buku.kategori_buku')->groupStart()->like('no_buku', $keyword)->orLike('nama_buku', $keyword)->orLike('pengarang_buku', $keyword)->orLike('penerbit_buku', $keyword)->groupEnd()->where('nama_kategori', session()->get('kategori_book'))->paginate(10, 'buku');
                // Menghitung jumlah
                ...
                // Mengambil semua data buku + join kategori
                $data['all_buku'] = $this->BukuModel->select('no_buku, nama_buku, sampul_buku, nama_kategori, status_buku')->join('kategori', 'kategori.id_kategori = buku.kategori_buku')->like('no_buku', $keyword)->orLike('nama_buku', $keyword)->orLike('pengarang_buku', $keyword)->orLike('penerbit_buku', $keyword)->paginate(10, 'buku');
                // Menghitung jumlah
            ...
            // Mengambil semua data buku + join kategori
            $data['all_buku'] = $this->BukuModel->select('no_buku, nama_buku, sampul_buku, nama_kategori, status_buku')->where('nama_kategori', session()->get('kategori_book'))->join('kategori', 'kategori.id_kategori = buku.kategori_buku')->paginate(10, 'buku');
            ...
            // Mengambil semua data buku + join kategori
            $data['all_buku'] = $this->BukuModel->select('no_buku, nama_buku, sampul_buku, nama_kategori, status_buku')->join('kategori', 'kategori.id_kategori = buku.kategori_buku')->paginate(10, 'buku');
            // Menghitung semua data buku yang ditemukan
    ...
    public function kategori()
    {
        ...
        if ($this->request->getVar('keyword')) {
            $keyword = $this->request->getVar('keyword');
            $data['all_kategori'] = $this->KategoriModel->select('id_kategori, nama_kategori, kategori-created_at')->like('nama_kategori', $keyword)->paginate(10, 'kategori');
            $data['jumlah_kategori'] = $this->KategoriModel->select('id_kategori')->like('nama_kategori', $keyword)->countAllResults();
        } else {
            $data['all_kategori'] = $this->KategoriModel->select('id_kategori, nama_kategori, kategori-created_at')->paginate(10, 'kategori');
    ...
    public function peminjaman()
    {
        ...
        if ($this->request->getVar('keyword')) {
            ...
            $keyword = $this->request->getVar('keyword');
            // Mencari buku
            $data['peminjaman'] = $this->BukupinjamModel->select('nama_user, foto_profil, nama_buku, sampul_buku, tanggal_pinjam, id_bukupinjam')->join('user', 'user.nis = bukupinjam.nis_bukupinjam')->join('buku', 'buku.no_buku = bukupinjam.no_bukupinjam')->where('status_bukupinjam', 0)->groupStart()->like('nis', $keyword)->orLike('nama_user', $keyword)->orLike('no_buku', $keyword)->orLike('nama_buku', $keyword)->orLike('pengarang_buku', $keyword)->orLike('penerbit_buku', $keyword)->groupEnd()->orderBy('tanggal_pinjam', 'DESC')->paginate(10, 'bukupinjam');
            ...
            $data['peminjaman'] = $this->BukupinjamModel->select('nama_user, foto_profil, nama_buku, sampul_buku, tanggal_pinjam, id_bukupinjam')->where('status_bukupinjam', 0)->join('user', 'user.nis = bukupinjam.nis_bukupinjam')->join('buku', 'buku.no_buku = bukupinjam.no_bukupinjam')->orderBy('tanggal_pinjam', 'DESC')->paginate(10, 'bukupinjam');
    ...
    public function pengembalian()
    {
        ...
        if ($this->request->getVar('keyword')) {
            ...
            $data['pengembalian'] = $this->BukupinjamModel->select('nama_user, foto_profil, nama_buku, sampul_buku, tanggal_kembali, id_bukupinjam')->where('status_bukupinjam', 1)->join('user', 'user.nis = bukupinjam.nis_bukupinjam')->join('buku', 'buku.no_buku = bukupinjam.no_bukupinjam')->orderBy('tanggal_kembali', 'DESC')->paginate(10, 'bukupinjam');
